...
::: {.callout-note title="Fase 1: Estudiar independientemente [7 minutos]"}
  ...
  * Estudia el material proporcionado para los modelos de conteo
  ...
  * Prepara un resumen en la bitácora para compartir mas tarde. Para cada pregunta, contesta con "Si" / "No", 
  y agrega una breve explicación. Toma en cuenta, y reporta cuando es relevante: coeficientes, intervalos de 
  confianza, graficos QQ, y pruebas de simulacion.
  * Preguntas para el resumen en su bitacora (si / no + porque):
      1. La abundancia cambia con la distancia?
      2. La estructura de varianza (dispersión) asumida por el modelo parece apropiada? 
...
**El resumen de Fase 1, escrito en su bitacora, representa su entrada de bitacora calificada**
...
Unos ecologos de campo estudian la abundancia de diferentes especies a lo largo de un gradiente ambiental. La abundancia de cada especie puede sugerir diferentes patrones de respuesta a las condiciones ambientales:
...
## Modelos generalizados lineales para conteos
