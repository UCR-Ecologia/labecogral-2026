...
::: {.fragment}
**Evidencia compatible con B y con un mecanismo de estabilidad temporal.**

La heterogeneidad aumenta la riqueza, lo que apoya B. Además, se asocia con menor recambio temporal, lo que sugiere mayor estabilidad. Sin embargo, esto no apoya directamente C, porque C vinculaba la estabilidad con el área, no con la heterogeneidad.
:::

::: {.fragment}
¿Hipótesis parcialmente compatibles, o predictores cuyos efectos se solapan o interactúan?
:::
...
::: {.fragment}
* Mayor heterogeneidad se asocia con menor recambio.
* Esto sugiere que la heterogeneidad tambien mejora estabilidad, que no apoya hipotesis C directamente.
* C vinculaba la estabilidad con area, no con heterogeneidad.
:::
