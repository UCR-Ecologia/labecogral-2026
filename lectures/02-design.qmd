...
## Como guardarse de la pseudorreplicacion? {.smaller}


::: {.fragment}

Un escenario comun. La gente muchas veces hace la siguente asociacion:

> organismos (individuos) diferentes = replicas biologicas
...
> aunque claramente, sinco Daphnia en el mismo mesocosmo son sinco individuos

> **las sinco Daphnia no son replicas independientes del tratamiento del microcosmo**
...
> ¿Dónde ocurrió la asignación independiente del tratamiento?
...
## Vinclulo entre Hypotesis y Deseño
