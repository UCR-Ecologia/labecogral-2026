...
**Promedio de diversidad en ciudades**: 3.3  
**Promedio de diversidad en parques nacionales**: 7.6  
**Resultado**: La diversidad de líquenes es mayor en los parques nacionales que en las ciudades.

:::

::: {.fragment}

*Todo bien con este estudio? ¿Podemos concluir que la menor diversidad de líquenes está asociada con la contaminación?*
...
H1: La tolerancia a la salinidad experimental corresponde al rango natural de salinidad en el que se encuentra la especie, porque especies distribuidas en ambientes con diferentes salinidades mantienen tolerancia a un rango más amplio de salinidad que especies que experimentan salinidad constante.
...
```
      ...
      ↓   ↓   ↓          ↓   ↓   ↓          ↓   ↓   ↓
     C1  C2  C3         C1  C2  C3         C1  C2  C3
   cepa cepa cepa     cepa cepa cepa     cepa cepa cepa
```
...
> * Unidad de inferencia: **especie**  
> * Sample size: **5 especies** 
> * Las cepas permiten medir la variación dentro de cada especie.
:::
...
H2: Dentro de una especie, las cepas que originan de ambientes con salinidad variable tienen tolerancia a la salinidad mas amplia.
...
::: {.fragment}
> * Unidad de inferencia: **cepa**  
> * Sample size: **3 cepas por especie**  
> * Los 3 cultivos por cepa permiten medir la variación (incertidumbre) dentro de cada cepa.
:::
...
H3: La tolerancia a la salinidad es generalmente determinada por el genotipo de la cepa, y por lo tanto, los cultivos independientes de la misma cepa tendrán tolerancia similar. Diferencias entre cultivos de la misma cepa reflejan variación experimental.
